...
<div class="row">
    ...
    <div class="col-sm-12 col-md-4 text-right">
        <a href="<?php echo base_url()?>index.php/GradosControlador/insertar" class="btn btn-primary">Agregar</a>
    </div>
</div>
<br>
<div class="row">
...
<script>
    $(function(){
        ...
        function buscar(){
            ...
            $.post('<?php echo base_url()?>index.php/GradosControlador/buscar',{criterio:criterio}, function(response){
