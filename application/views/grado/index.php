...
<div class="row">
    ...
    <div class="col-sm-12 col-md-4 text-right">
        <a href="<?php echo base_url()?>index.php/GradoControlador/insertar" class="btn btn-primary">Agregar</a>
    </div>
</div>
<br>
<div class="row">
    <div class="col-12" id="divTabla">
        <?php $this->load->view('grado/tabla_grado'); ?>
    </div>
</div>
    ...
    $(function(){
        $(document).on("click", "button[data-eliminar]", function (evt) {
            ...
            swal({
                ...
                if (result) {                    
                    var data = {id: id};
                    $.post('<?php echo base_url()?>index.php/GradoControlador/eliminar',data,function(response){
                        if(response == 'ok'){
        ...
        function buscar(){
            ...
            $.post('<?php echo base_url()?>index.php/GradoControlador/buscar',{criterio:criterio}, function(response){
